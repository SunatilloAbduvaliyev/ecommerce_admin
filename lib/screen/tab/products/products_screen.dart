                ...
                :  Padding(
                  ...
                  return Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Image.network(productList[index].image, fit: BoxFit.cover,
                        ),
                        Text(productList[index].title,style: AppTextStyle.semiBold,),
                        Text(productList[index].description,style: AppTextStyle.regular,),
                        Row(
                          children: [
                            Expanded(child: Text("\$${productList[index].price}",style: AppTextStyle.regular,)),
                            IconButton(
                              onPressed: (){
                                Navigator.push(
                                    context,
